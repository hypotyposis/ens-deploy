...
const BaseRegistrar = artifacts.require("@ensdomains/ens-contracts/BaseRegistrar");
// const ETHRegistrarController = artifacts.require("@ensdomains/ens-contracts/ETHRegistrarController");
...
module.exports = function (deployer, network, accounts) {
  ...
  deployer.deploy(ENS)
    ...
    // BaseRegistrar
    // .then(function () {
    //   return deployer.deploy(BaseRegistrar, ens.address, namehash.hash(tld));
    // })
    // .then(function (registrarInstance) {
    //   registrar = registrarInstance;
    //   return setupRegistrar(ens, registrar);
    ...
    // .then(function () {
    //   return deployer.deploy(ETHRegistrarController, ens.address, namehash.hash(tld));
    // })
    // .then(function (registrarInstance) {
    //   registrar = registrarInstance;
    //   return setupRegistrar(ens, registrar);
